  ...
  return (
    <nav className="relative bg-white shadow dark:bg-gray-800">
      <div className="container px-7 py-0 mx-auto md:flex md:justify-between md:items-center">
        ...
        {/* Mobile Menu, hidden on medium screens and above */}
        <div
          className={`${
        ...
        >
          <div className="flex flex-col md:flex-row md:mx-6">
            <a
              className="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-orange-400 dark:hover:text-orange-300 md:mx-4 md:my-0"
              href="#"
            >
              Bienvenida
            </a>
        ...
        {/* Normal Menu, visible on medium screens and above */}
